...
/*            for(Employee emp : emps)
           ...
           /* for(Object[] item : items)
            ...
            //query.setParameter("jobid", "IT_PROG"); // 이름기반
...
//            System.out.println(avgsal);
            ...
            // jobid으로 정렬 후 3페이지 조회 : 페이징 (페이지당 출력건수 : 15)
            // setFirstResult(startpos) : 페이징 시작 위치
            // setMaxResult(getdatacnt) : 조회할 데이터 수
            jpql = "select e from Employee e order by e.jobid";
...
//                System.out.println(item[0] + "/" + item[1] + "/" + item[2]);
            ...
            //jpql = "select e.fname, e.jobid, d.dname from Employee e inner join e.department d where e.deptid = :deptid";
            //jpql = "select e.fname, e.jobid, d.dname from Employee e inner join e.department d where e.deptid = 60";
            //List<Object[]> items = em.createQuery(jpql).getResultList();
