...
public class HelloHBM05 {
    public static void main(String[] args) {
        ...
        try {
            ...
            // 조회 - 전체 사원, 페이징
           /* Criteria query = sess.createCriteria(Employee.class);
            // 5번째 사원부터 10명 가져온다.105번 부터 시작했으니 6번째
           ...
           /* Criteria query = sess.createCriteria(Employee.class);
            query.setProjection(Projections.projectionList()
                    .add(Projections.groupProperty("jobid")) //groupby
            ...
            */
            ...
            query.add(Expression.like("fname", "eve")); // 포함?
            query.add(Expression.like("fname", "St", MatchMode.START)); // st %
            query.add(Expression.like("fname", "en", MatchMode.END)); // % en
            ...
            // join : 부서번호가 60번인 사원들의 일음, 직책, 부서명 조회
            // FetchMode : 조인의 종류 정의
